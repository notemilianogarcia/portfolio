...
|-----------|-------------|
| 0 — Project Scaffold | Create repo, packaging, config system, and artifact conventions |
| 1 — Dataset Ingestion | Implement dataset loader and patient-level deterministic splits |
| 2 — Baseline Model | Implement pretrained backbone + head, train baseline with AUROC metrics |
| 3 — Uncertainty Estimation | Add dropout strategy, implement T-pass inference and calibration metrics |
| 4 — Visual Explanations | Generate Grad-CAM heatmaps for curated samples |
| 5 — Second Explainability Method | Add Score-CAM and compare side-by-side |
| 6 — Explanation Stability Analysis | Compute stability metrics and relate to uncertainty/confidence/correctness |
| 7 — Failure Case Audit | Curate failure examples and write report with limitations |
| 8 — Portfolio Packaging | Polish README with motivation, architecture, and repro instructions |
