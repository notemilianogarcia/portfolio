...
Create repo, packaging, config system, and artifact conventions.

### Milestone 1 — Dataset Ingestion + Clean Splits
Implement dataset loader and patient-level deterministic splits.

### Milestone 2 — Baseline Transfer Learning Model
Implement pretrained backbone + head, train baseline with AUROC metrics.

### Milestone 3 — Uncertainty Estimation (MC Dropout)
Add dropout strategy, implement T-pass inference and calibration metrics.

### Milestone 4 — Visual Explanations (Grad-CAM)
Generate Grad-CAM heatmaps for curated samples.

### Milestone 5 — Second Explainability Method (Score-CAM)
Add Score-CAM and compare side-by-side.

### Milestone 6 — Explanation Stability Analysis
Compute stability metrics and relate to uncertainty/confidence/correctness.

### Milestone 7 — Failure Case Audit + Final Report
Curate failure examples and write report with limitations.

### Milestone 8 — Portfolio Packaging
Polish README with motivation, architecture, and repro instructions.
