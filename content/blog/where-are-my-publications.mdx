...
<div className="flex gap-4 mt-8 mb-8">
  <a href="https://github.com/notemilianogarcia" target="_blank" rel="noopener noreferrer" className="min-h-11 rounded-xl border-2 border-accent px-6 py-3 text-sm font-bold text-accent bg-bg transition-transform hover:scale-105">
    View on GitHub
  </a>
