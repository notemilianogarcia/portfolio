...
<Figure src="/publications/kan/02-performance-comparison.svg" caption="Figure 2. Macro-F1 versus trainable head parameters across audio, text, and fusion. FKF provides a favourable performance-capacity trade-off, particularly under limited capacity." alt="Three-panel performance comparison across audio, text, and fusion settings" />
